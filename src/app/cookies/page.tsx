        ...
        <div className="p-8">
          ...
          <div className="prose prose-invert max-w-none text-[#A1A1AA]">
            <section className="mb-6">
              <h2 className="text-white">1. What Are Cookies</h2>
              <p className="mb-3">
            ...
            <section className="mb-6">
              <h2 className="text-white">2. How We Use Cookies</h2>
              ...
              <h3 className="text-white">Targeting Cookies</h3>
              <p className="mb-3">
            ...
            <section className="mb-6">
              <h2 className="text-white">3. Third-Party Cookies</h2>
              <p className="mb-3">
            ...
            <section className="mb-6">
              <h2 className="text-white">4. Managing Cookies</h2>
              <p className="mb-3">
            ...
            <section className="mb-6">
              <h2 className="text-white">5. Changes to This Cookie Policy</h2>
              <p className="mb-3">
